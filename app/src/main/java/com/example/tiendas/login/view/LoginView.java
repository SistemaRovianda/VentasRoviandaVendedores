package com.example.tiendas.login.view;
...
import com.example.tiendas.login.presenter.LoginPresenter;
import com.example.tiendas.login.presenter.LoginPresenterContract;
...
public class LoginView extends Fragment implements View.OnClickListener,LoginViewPresenter{
    ...
    public void goToHome(String nameUser){
        ...
        navController.navigate(LoginViewDirections.actionLoginViewToPedidoView(nameUser));
    }
