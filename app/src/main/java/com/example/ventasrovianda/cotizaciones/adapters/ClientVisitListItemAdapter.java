package com.example.ventasrovianda.cotizaciones.adapters;
...
public class ClientVisitListItemAdapter extends BaseAdapter {
    ...
    VisitsMapViewContract mainView;
    public ClientVisitListItemAdapter(Context appContext, List<ClientVisitListItem> visits, VisitsMapViewContract visitsMapView){
